...
def default_seed_devices() -> list[Device]:
    ...
    seeds = [
        ...
        Device(
            id="media_player.family_room_tv",
            name="Family room TV",
            domain="media_player",
            model="HIRI-TV",
            area="family_room",
            state={"state": "off", "volume_level": 0.3, "source": "HDMI 1"},
            attributes={
                "device_class": "tv",
                "source_list": [
                    "HDMI 1",
        ...
        Device(
            id="media_player.patio_speaker",
            name="Patio speaker",
            domain="media_player",
            model="HIRI-SPK",
            area="patio",
            state={"state": "idle", "volume_level": 0.45, "source": "Bluetooth"},
            attributes={
        ...
        Device(
            id="media_player.den_streamer",
            name="Den streamer",
            domain="media_player",
            model="HIRI-STREAM",
            area="den",
            state={"state": "idle", "volume_level": 0.35, "source": "Plex"},
            attributes={
